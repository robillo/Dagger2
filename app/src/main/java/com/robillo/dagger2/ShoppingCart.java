...
public class ShoppingCart {
    ...
    public ShoppingCart(SharedPreferences preferences) {
    ...
    private void initShoppingCart() {
        ...
        if (preferences.getBoolean(OPEN_CART_EXITS, false)){
            String serializedCartItems = preferences.getString(SERIALIZED_CART_ITEMS, "");
            String serializedCustomer = preferences.getString(SERIALIZED_CUSTOMER, "");
